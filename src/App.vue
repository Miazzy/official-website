...
@media only screen and (min-width: 3700px) and (max-width: 3799px) {
  ...
  #container.plans {
    ...
    main {
      transform: scale(1.975) !important;
      transform-origin: top left !important;
    }
...
@media only screen and (min-width: 3700px) and (max-width: 3749px) {
  .header .navbar {
    margin-left: calc(51.5vw - 10px) !important;
    margin-top: 6.75vh !important;
    transform: scale(1.75) !important;
  ...
  #container.plans {
    ...
    main {
      transform: scale(1.945) !important;
      transform-origin: top left !important;
    }
...
@media only screen and (min-width: 3650px) and (max-width: 3699px) {
  .header .navbar {
    margin-left: calc(51.5vw - 10px) !important;
    margin-top: 6.75vh !important;
    transform: scale(1.75) !important;
  ...
  #container.plans {
    ...
    main {
      transform: scale(1.935) !important;
      transform-origin: top left !important;
    }
...
@media only screen and (min-width: 3600px) and (max-width: 3649px) {
  .header .navbar {
    margin-left: calc(51.5vw - 10px) !important;
    margin-top: 6.75vh !important;
    transform: scale(1.75) !important;
  ...
  #container.plans {
    ...
    main {
      transform: scale(1.885) !important;
      transform-origin: top left !important;
    }
...
@media only screen and (min-width: 3550px) and (max-width: 3599px) {
  .header .navbar {
    margin-left: calc(51.5vw - 10px) !important;
    margin-top: 6.75vh !important;
    transform: scale(1.75) !important;
...
@media only screen and (min-width: 3500px) and (max-width: 3549px) {
  .header .navbar {
    margin-left: calc(51.5vw - 10px) !important;
    margin-top: 6.75vh !important;
    transform: scale(1.75) !important;
  ...
  #container.plans {
    ...
    main {
      transform: scale(1.835) !important;
      transform-origin: top left !important;
    }
...
@media only screen and (min-width: 3450px) and (max-width: 3499px) {
  .header .navbar {
...
@media only screen and (min-width: 3400px) and (max-width: 3449px) {
  .header .navbar {
    margin-left: calc(47.5vw - 10px) !important;
    margin-top: 6.05vh !important;
    transform: scale(1.45) !important;
...
@media only screen and (min-width: 2800px) and (max-width: 2899px) {
  ...
  #container.plans {
    ...
    .plans.container .middle-content {
      margin: -68px 190px 0 190px !important;
    }
  ...
  #container.projectCases {
    ...
    .project-cases .content-box-1 .intelligent-operation-box{
      margin: -68px auto 0 190px !important;
    }
  }
  ...
  #container.aboutus {
    ...
    .aboutus.container .middle-section {
      margin: 0px auto 0 275px !important;
    }
    ...
    .aboutus.container .bottom-section {
      ...
      .banner {
          margin: 0px auto 0 -30px !important;
      }
...
@media only screen and (min-width: 2700px) and (max-width: 2799px) {
  ...
  #container.plans {
    ...
    .plans.container .bottom-section {
      ...
      .business-container {
        margin: 250px 80px 0px calc(18.5vw + 0px) !important;
      }
    }
  }
...
@media only screen and (min-width: 2500px) and (max-width: 2599px) {
  ...
  #container.plans {
    ...
    .plans.container .middle-content {
      margin: -68px auto 0 205px !important;
    }
    ...
    .plans.container .bottom-section {
      .banner {
        margin: 56px 0 0 290px !important;
      }
      .business-container {
        margin: 250px 80px 0px calc(21.75vw + 0px) !important;
      }
    }
  }
  ...
  #container.projectCases {
    ...
    .project-cases .content-box-2 .smart-agriculture-box {
      margin: -20px auto 0 290px !important;
...
@media screen and (min-width: 1650px) and (max-width: 1699px) {
  ...
  .header .navbar {
    margin-left: calc(34vw + 0.5px) !important;
    margin-top: calc(3.95vh + 0px) !important;
...
@media screen and (min-width: 1500px) and (max-width: 1599px) {
  ...
  .aboutus.container .top-section .banner {
    margin: 195px 0 0 -65px !important;
  ...
  .aboutus.container .middle-section {
    ...
    transform-origin: top left !important;
    margin: 10px 210px 0 210px !important;
  ...
  .plans.container .top-section .banner {
    margin: 190px 0 0 -35px !important;
  }
  ...
  .plans.container .middle-content {
    margin: -108px 182px 0 182px !important;
    transform: scale(0.95) !important;
    background-image: url('/src/assets/images/plan_wenli.jpg') !important;
    background-size: cover !important;
    background-position: center !important;
  ...
  .plans.container .bottom-section .business-container {
    margin: 220px 80px 0px calc(30vw + 80px) !important;
  ...
  .aboutus.container .submid-section {
    margin: -220px 0 0 0;
    padding: 0px 210px 0 210px !important;
    ...
    .content-container {
      ...
      margin: 0.5px 0 0 -185.5px !important;
      transform: scale(0.80) !important;
    }
  }
...
@media screen and (min-width: 1400px) and (max-width: 1499px) {
  ...
  .aboutus.container .top-section .banner {
    margin: 195px 0 0 -105px !important;
...
@media screen and (min-width: 1250px) and (max-width: 1280px) and (min-height: 500px) and (max-height: 595px) {
  ...
  .home .carousel-container .carousel-slide {
    ...
    .quota {
      .segment {
        ...
        top: calc(40vh + 8px) !important;
        right: calc(20vw + 18px) !important;

        &:last-child {
          top: calc(40vh + 88px) !important;
          right: calc(20vw + 18px) !important;
        }
      }
      ...
      .indicator-component {
        ...
        &:nth-child(1) {
          right: calc(20vw + 65px) !important;
        }

        &:nth-child(2) {
          right: calc(10vw + 25px) !important;
        }
...
@media screen and (min-width: 1200px) and (max-width: 1250px) and (min-height: 500px) and (max-height: 595px) {
